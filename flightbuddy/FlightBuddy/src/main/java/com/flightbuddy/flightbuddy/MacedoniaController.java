...
public class MacedoniaController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Macedonia.png")
                )
        );

        // === INFO ===
        Label title = new Label("Macedonia");
...
""");
        ...
        Button skp = new Button("Skopje (SKP)");

        skp.setOnAction(e -> openFlightsView(Airport.SKP));



        skp.setMaxWidth(Double.MAX_VALUE);
