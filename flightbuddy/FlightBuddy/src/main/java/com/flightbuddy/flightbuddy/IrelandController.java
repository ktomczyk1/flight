...
public class IrelandController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Ireland.png")
                )
        );

        // === INFO ===
        Label title = new Label("Irlandia");
...
""");
        ...
        // === LOTNISKA =
        Button dub = new Button("Dublin (DUB)");

        dub.setOnAction(e -> openFlightsView(Airport.DUB));


        dub.setMaxWidth(Double.MAX_VALUE);
