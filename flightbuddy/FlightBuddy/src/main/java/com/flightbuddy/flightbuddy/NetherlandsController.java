...
public class NetherlandsController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Netherlands.png")
                )
        );

        // === INFO ===
        Label title = new Label("Holandia");
...
""");
        ...
        Button ams = new Button("Amsterdam (AMS)");

        ams.setOnAction(e -> showTestFlights("Amsterdam", "AMS"));



        ams.setMaxWidth(Double.MAX_VALUE);
