...
public class FinlandController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Finland.png")
                )
        );

        // === INFO ===
        Label title = new Label("Finlandia");
...
""");
        ...
        Button hel = new Button("Helsinki (HEL)");
        Button oul = new Button("Oulu (OUL)");

        hel.setOnAction(e -> openFlightsView(Airport.HEL));
        oul.setOnAction(e -> openFlightsView(Airport.OUL));



        hel.setMaxWidth(Double.MAX_VALUE);
        oul.setMaxWidth(Double.MAX_VALUE);
