...
public class MontenegroController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Montenegro.png")
                )
        );

        // === INFO ===
        Label title = new Label("Czarnogóra");
...
""");
        ...
        Button tgd = new Button("Podgorica (TGD)");

        tgd.setOnAction(e -> showTestFlights("Podgorica", "TGD"));



        tgd.setMaxWidth(Double.MAX_VALUE);
