...
public class DenmarkController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Denmark.png")
                )
        );

        // === INFO ===
        Label title = new Label("Dania");
...
""");
        ...
        Button cph = new Button("Kopenhaga (CPH)");

        cph.setOnAction(e -> showTestFlights("Kopenhaga", "CPH"));
