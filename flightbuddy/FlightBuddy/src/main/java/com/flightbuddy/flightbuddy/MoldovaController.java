...
public class MoldovaController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Moldova.png")
                )
        );

        // === INFO ===
        Label title = new Label("Mołdawia");
...
""");
        ...
        Button rmo = new Button("Kiszyniów (RMO)");

        rmo.setOnAction(e -> showTestFlights("Kiszyniów", "RMO"));



        rmo.setMaxWidth(Double.MAX_VALUE);
