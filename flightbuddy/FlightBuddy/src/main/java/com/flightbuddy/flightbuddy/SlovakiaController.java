...
public class SlovakiaController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Slovakia.png")
                )
        );

        // === INFO ===
        Label title = new Label("Słowacja");
...
""");
        ...
        bts.setOnAction(e -> showTestFlights("Bratysława", "BTS"));



        bts.setMaxWidth(Double.MAX_VALUE);
