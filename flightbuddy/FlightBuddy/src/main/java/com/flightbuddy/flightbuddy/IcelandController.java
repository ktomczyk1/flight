...
public class IcelandController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Iceland.png")
                )
        );

        // === INFO ===
        Label title = new Label("Islandia");
...
""");
        ...
        rkv.setOnAction(e -> showTestFlights("Reykjavik", "RKV"));



        rkv.setMaxWidth(Double.MAX_VALUE);
