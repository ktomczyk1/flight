...
public class CroatiaController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Croatia.png")
                )
        );

        // === INFO ===
        Label title = new Label("Chorwacja");
...
""");
        ...
        spu.setOnAction(e -> openFlightsView(Airport.SPU));
        zag.setOnAction(e -> openFlightsView(Airport.ZAG));



        spu.setMaxWidth(Double.MAX_VALUE);
        zag.setMaxWidth(Double.MAX_VALUE);
