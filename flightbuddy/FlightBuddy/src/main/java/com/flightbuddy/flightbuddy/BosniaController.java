...
public class BosniaController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Bosnia.png")
                )
        );

        // === INFO ===
        Label title = new Label("Bośnia i Hercegowina");
...
""");
        ...
        sjj.setOnAction(e -> showTestFlights("Sarajewo", "SJJ"));



        sjj.setMaxWidth(Double.MAX_VALUE);
