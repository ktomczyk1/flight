...
public class FranceController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_France.png")
                )
        );

        // === INFO ===
        Label title = new Label("Francja");
...
""");
        ...
        cdg.setOnAction(e -> openFlightsView(Airport.CDG));
        mrs.setOnAction(e -> openFlightsView(Airport.MRS));
        nce.setOnAction(e -> openFlightsView(Airport.NCE));



        cdg.setMaxWidth(Double.MAX_VALUE);
        mrs.setMaxWidth(Double.MAX_VALUE);
