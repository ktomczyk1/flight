...
public class PolandController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Poland.png")
                )
        );

        // === INFO ===
        Label title = new Label("Polska");
...
""");
        ...
        Button ktw = new Button("Katowice (KTW)");

        waw.setOnAction(e -> showTestFlights("Warszawa Chopina", "WAW"));
        krk.setOnAction(e -> showTestFlights("Kraków Balice", "KRK"));
        gdn.setOnAction(e -> showTestFlights("Gdańsk", "GDN"));
        ktw.setOnAction(e -> showTestFlights("Katowice", "KTW"));


        waw.setMaxWidth(Double.MAX_VALUE);
        krk.setMaxWidth(Double.MAX_VALUE);
        gdn.setMaxWidth(Double.MAX_VALUE);
        ktw.setMaxWidth(Double.MAX_VALUE);
