...
public class SwitzerlandController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Switzerland.png")
                )
        );

        // === INFO ===
        Label title = new Label("Szwajcaria");
...
""");
        ...
        zrh.setOnAction(e -> showTestFlights("Zurych", "ZRH"));



        zrh.setMaxWidth(Double.MAX_VALUE);
