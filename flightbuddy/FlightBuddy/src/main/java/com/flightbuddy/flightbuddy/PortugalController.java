...
public class PortugalController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Portugal.png")
                )
        );

        // === INFO ===
        Label title = new Label("Portugalia");
...
""");
        ...
        lis.setMaxWidth(Double.MAX_VALUE);
        opo.setMaxWidth(Double.MAX_VALUE);
