...
public class RussiaController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Russia.png")
                )
        );

        // === INFO ===
        Label title = new Label("Rosja");
...
""");
        ...
        vvo.setOnAction(e -> showTestFlights("Władywostok", "VVO"));
        led.setOnAction(e -> showTestFlights("Petersburg", "LED"));
        svo.setOnAction(e -> showTestFlights("Moskwa", "SVO"));



        vvo.setMaxWidth(Double.MAX_VALUE);
        led.setMaxWidth(Double.MAX_VALUE);
        svo.setMaxWidth(Double.MAX_VALUE);
