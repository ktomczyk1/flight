...
public class LatviaController {
    ...
    public void initialize() {
        ...
        mapImage.setImage(
                new Image(
                        getClass().getResourceAsStream("/Map_Latvia.png")
                )
        );

        // === INFO ===
        Label title = new Label("Łotwa");
...
""");
        ...
        rix.setOnAction(e -> showTestFlights("Ryga", "RIX"));



        rix.setMaxWidth(Double.MAX_VALUE);
